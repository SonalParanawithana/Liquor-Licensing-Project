...
const LicenseeForm = () => {
  ...
  const [holdsOtherLicenses, setHoldsOtherLicenses] = useState(false); //ok
  const [technicalCrimeReport, setTechnicalCrimeReport] = useState(false);
  ...
  // const [wallsType, setWallsType] = useState("");
  const [otherLicenses, setOtherLicenses] = useState([]); //ok
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${base_url}/application/licenseapplications`, {
        ...formData,
        otherLicenses,
        holdsOtherLicenses,
        hasLiquorLicense,
